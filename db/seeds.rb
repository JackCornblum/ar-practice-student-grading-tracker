...
20.times do
  ...
  StudentExam.create(grade: grade_score, teacher_comment: "good job", exam_id: exam.id, student_id: student.id) # <- insert key value pairs required to create a studentExam!
